  ...
  if (!isLibrarian) {
    return (
      <div style={{ padding: '40px 20px', textAlign: 'center', fontFamily: 'Poppins, sans-serif' }}>
        ...
        <h2 style={{ color: '#1a1a2e', marginBottom: 10 }}>Access Denied</h2>
        <p style={{ color: '#64748b' }}>You need librarian privileges to access event management.</p>
      </div>
    );
  }
  ...
  return (
    <div style={{ padding: '24px 20px', maxWidth: 1400, margin: '0 auto', fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 14, marginBottom: 24 }}>
        {[
          { l: 'Total Events', v: events.length, c: '#6366f1' },
          { l: 'Active', v: totalActive, c: '#10b981' },
          { l: 'Upcoming', v: totalUpcoming, c: '#ef5a24' },
          { l: 'Public', v: totalPublic, c: '#8b5cf6' },
        ].map(s => (
          <div key={s.l} style={{
