...
const StudentDashboard = () => {
  ...
  const cardStyle = (color) => ({
    background: 'white', borderRadius: 16, padding: '24px', border: '1px solid #e8ecf0',
  ...
  return (
    <div style={{ padding: '32px 28px', maxWidth: 1200, margin: '0 auto', fontFamily: 'Poppins, sans-serif' }} className="animate-fade-in">
      {/* Banner */}
      <div style={{ background: 'linear-gradient(135deg, #1a1a2e 0%, #312e81 50%, #ef5a24 100%)', borderRadius: 20, padding: '32px 40px', color: 'white', marginBottom: 28, position: 'relative', overflow: 'hidden' }}>
